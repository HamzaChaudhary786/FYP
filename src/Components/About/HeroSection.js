            ...
            <div className=' bg-gray-900 '>
                ...
                <div className='grid grid-cols-2 mt-12  '>
                    ...
                    <div className='pl-24 pr-24 '>
                        ...
                        <h1 className='text-white  text-6xl font-bold'>Mission</h1>
                        <p className='mt-6 font-semibold  text-cyan-300  w-96 text-lg '>Empower people and organisations to earn and save through cheaper, accessible, and sustainable computing by utilising spare capacity.</p>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div className=' grid grid-cols-1 lg:grid lg:grid-cols-3 justify-items-center  mt-6'>
                        ...
                        <div className='bg-gray-700 h-[600px] w-96 grid justify-items-center shadow-lg shadow-gray-900 rounded-lg lg:mt-[0px] hover:border-white hover:border-2  hover:scale-105 duration-500 mb-8 '>
                        ...
                        <div className='bg-gray-700 hover:border-white hover:border-2  h-[680px] w-96 grid justify-items-center shadow-lg shadow-gray-900 rounded-lg lg:mt-[70px]  hover:scale-105 duration-500 mb-8 mt '>
